namespace ProyectoIntegrador.formularios
{
    partial class ProfesorMenu
    {
        ...
        private void InitializeComponent()
        {
            ...
            LBienvenido.Size = new Size(85, 18);
            LBienvenido.TabIndex = 3;
            LBienvenido.Text = "Reservas";
            // 
            // panel7
            // 
            panel7.Anchor = AnchorStyles.Top | AnchorStyles.Bottom;
            panel7.Controls.Add(BReservarAula);
            ...
            // BReservarAula
            // 
            BReservarAula.BackColor = Color.FromArgb(17, 97, 238);
            BReservarAula.ForeColor = Color.White;
            BReservarAula.Location = new Point(604, 355);
            BReservarAula.Name = "BReservarAula";
            BReservarAula.Size = new Size(184, 31);
            BReservarAula.TabIndex = 4;
            BReservarAula.Text = "Reservar Aula";
            BReservarAula.UseVisualStyleBackColor = false;
            BReservarAula.Click += BReservarAula_Click;
            // 
            // dataGridView1
            // 
